<div class="row-fluid">
    <div class="span12">
        <div class="page-header">
            <div class="row-fluid">
                <div class="span12">
                    <h1><?php echo $this->pageHeader; ?><?php $this->widget('application.widgets.AdminBtn', array('method' => 'moduleRecordDetail', 'data' => array('moduleName' => 'blog', 'id' => $model->id, 'edit' => '/altadmin/blog/default/edit/' . $model->id, 'delete' => '/altadmin/blog/default/delete'))); ?>
                    </h1>
                </div>
            </div>
        </div>
