...
<?php echo $form->textArea($model, 'text', array('rows' => 3, 'cols' => 40, 'class' => 'form-control span12', 'placeholder' => FrontEditFields::getSettings('CommentSettings', 'namePlaceholder'))); ?>
