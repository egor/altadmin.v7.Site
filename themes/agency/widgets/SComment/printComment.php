    ...
    foreach ($model as $value) {
        ...
        <div class="media" id="comment-<?php echo $value->id; ?>" <?php echo ($value->visibility == 0 ? 'style="color:#C6C6C6;"' : ''); ?>>
            ...
            <div class="media-body">
                <span class="label label-primary" style="float: left; margin-right: 10px; margin-left: 10px;"><?php echo date('d.m.Y H:i:s', $value->date); ?></span>
                <p class="media-heading" style="float: left;"><a href="#" name="comment-<?php echo $value->id; ?>"><?php echo $userName; ?></a>
                
                </p>
                <p>&nbsp;</p>
                <p style="float:left; margin-left: 10px;"><?php echo preg_replace( "#\r?\n#", "<br />", $value->text); ?></p>                                
                <br clear="all" />
                <?php
