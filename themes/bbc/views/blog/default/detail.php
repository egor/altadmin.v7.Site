    ...
    <div class="box">
        ...
        <div class="col-lg-12">
            ...
            <h2 class="intro-text text-center"><?php echo $this->pageHeader; ?>
                <?php $this->widget('application.widgets.AdminBtn', array('method' => 'moduleRecordDetail', 'data' => array('moduleName' => 'blog', 'id' => $model->id, 'edit' => '/altadmin/blog/default/edit/' . $model->id, 'delete' => '/altadmin/blog/default/delete'))); ?>
            </h2>
            <hr>
        </div>

        <small><?php echo date('d.m.Y', $model->date); ?></small>, <small><?php echo $model->blogSection->name; ?></small><br /><br />
        <?php
        $tags = '';
