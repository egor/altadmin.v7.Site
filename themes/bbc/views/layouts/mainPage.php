                    ...
                    <div id="carousel-example-generic" class="carousel slide">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <img class="img-responsive img-full" src="<?php echo Yii::app()->theme->baseUrl; ?>/images/slide-1.jpg" alt="">
                            </div>
                            <div class="item">
                                <img class="img-responsive img-full" src="<?php echo Yii::app()->theme->baseUrl; ?>/images/slide-2.jpg" alt="">
                            </div>
                            <div class="item">
                                <img class="img-responsive img-full" src="<?php echo Yii::app()->theme->baseUrl; ?>/images/slide-3.jpg" alt="">
                            </div>
                        </div>
