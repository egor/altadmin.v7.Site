...
<p><a href="/altadmin/portfolio/default/add" rel="tooltip" title="добавить" class="btn btn-primary b-add"><i class="icon-plus"></i> добавить работу</a></p>
<?php
if ($model) {    
?>
    ...
    <thead>
        ...
        foreach ($model as $value) {
            ...
            <tr id="tr-<?php echo $value->id; ?>">
                ...
                <td><a href="/altadmin/portfolio/default/edit/<?php echo $value->id; ?>" title="Редактировать" rel="tooltip"><?php echo date('d.m.Y', $value->date); ?></a></td>
                <td><?php echo $value->menuName; ?></td>
                <td><?php echo $value->portfolioSection->menuName; ?></td>
                ...
                <td>
                    <nobr>
                        <a href="/altadmin/portfolio/default/edit/<?php echo $value->id; ?>" title="Редактировать" rel="tooltip"><i class="icon-pencil"></i></a>&nbsp;                                                
...
<?php
$this->widget('application.modules.altadmin.widgets.DeleteOperations', array('method' => 'deleteTrRecord', 'data'=>array('url'=>'/altadmin/portfolio/default/delete', 'body'=>'<p>Вы уверены что хотите удалить работу <b>"<span id="recordName"></span>"</b>?</p>', 'td' => 6)));
$this->widget('application.modules.altadmin.widgets.DeleteOperations', array('method' => 'deleteMassRecord', 'data'=>array('url'=>'/altadmin/portfolio/default/deleteMass', 'body'=>'<p>Вы уверены что хотите удалить выбранные записи?</p>', 'reload' => '/altadmin/portfolio')));