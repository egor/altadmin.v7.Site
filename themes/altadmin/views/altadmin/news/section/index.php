...
<p><a href="/altadmin/news/section/add" rel="tooltip" title="добавить" class="btn btn-primary b-add"><i class="icon-plus"></i> добавить раздел</a></p>
<?php
if ($model) {    
?>
...
<table class="table table-striped table-bordered table-hover">
    <thead>
        <tr>
            ...
            <td><i class="icon-indent-right"></i> Новости</td>
        ...
        foreach ($model as $value) {
            ...
            <tr id="tr-<?php echo $value->id; ?>">
                ...
                <td><a href="/altadmin/news/section/edit/<?php echo $value->id; ?>" title="Редактировать" rel="tooltip"><?php echo $value->name; ?></a></td>
                <td><?php echo $value->newsCount; ?></td>
                ...
                <td>
                    <nobr>
                        <a href="/altadmin/news/section/edit/<?php echo $value->id; ?>" title="Редактировать" rel="tooltip"><i class="icon-pencil"></i></a>&nbsp;                                                
...
<?php
$this->widget('application.modules.altadmin.widgets.DeleteOperations', array('method' => 'deleteTrRecord', 'data'=>array('url'=>'/altadmin/news/section/delete', 'body'=>'<p>Вы уверены что хотите удалить раздел <b>"<span id="recordName"></span>"</b>?</p><p>Все новости этого раздела будут удалены навсегда.</p>', 'td' => 5)));
$this->widget('application.modules.altadmin.widgets.DeleteOperations', array('method' => 'deleteMassRecord', 'data'=>array('url'=>'/altadmin/news/section/deleteMass', 'body'=>'<p>Вы уверены что хотите удалить выбранные разделы?</p><p>Все новости этих разделов будут удалены навсегда.</p>', 'reload' => '/altadmin/news/section')));