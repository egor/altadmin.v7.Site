...
<p><a href="/altadmin/blog/default/add" rel="tooltip" title="добавить" class="btn btn-primary b-add"><i class="icon-plus"></i> добавить запись</a></p>
<?php
if ($model) {    
?>
    ...
    <thead>
        ...
        foreach ($model as $value) {
            ...
            <tr id="tr-<?php echo $value->id; ?>">
                ...
                <td><a href="/altadmin/blog/default/edit/<?php echo $value->id; ?>" title="Редактировать" rel="tooltip"><?php echo date('d.m.Y', $value->date); ?></a></td>
                <td><?php echo $value->menuName; ?></td>
                <td><?php echo $value->blogSection->name; ?></td>
...
<?php
$this->widget('application.modules.altadmin.widgets.DeleteOperations', array('method' => 'deleteTrRecord', 'data'=>array('url'=>'/altadmin/blog/default/delete', 'body'=>'<p>Вы уверены что хотите удалить запись <b>"<span id="recordName"></span>"</b>?</p>', 'td' => 6)));
$this->widget('application.modules.altadmin.widgets.DeleteOperations', array('method' => 'deleteMassRecord', 'data'=>array('url'=>'/altadmin/blog/default/deleteMass', 'body'=>'<p>Вы уверены что хотите удалить выбранные записи?</p>', 'reload' => '/altadmin/blog')));