    ...
    <table class="table table-hover">
        ...
        foreach ($model as $value) {
            ...
            <tr id="tr-<?php echo $value->id; ?>">
                ...
                <td><a href="/altadmin/page/editFieldEdit/<?php echo $value->id; ?>" title="редактировать" rel="tooltip"><?php echo $value->name; ?></a></td>
                <td><?php echo ($value->type == 'checkbox' ? ($value->value == 1 ? 'Да' : 'Нет') : $value->value); ?></td>        
                <td><nobr>
                <a href="/altadmin/page/editFieldEdit/<?php echo $value->id; ?>" title="редактировать" rel="tooltip"><i class="icon-pencil"></i></a>&nbsp;
            </nobr></td>
        </tr>          
        <?php
    }
