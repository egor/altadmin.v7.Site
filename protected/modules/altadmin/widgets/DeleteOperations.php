 ...
 */
class DeleteOperations extends CWidget
{
    /**
     * Вызываемый метод
     * 
    ...
    protected function deleteImage() {
        $this->render('webroot.themes.'.Yii::app()->theme->name.'.widgets.DeleteOperations.deleteImage', array('data' => $this->data));
    }
    ...
    protected function deleteTrRecord() {
        $this->render('webroot.themes.'.Yii::app()->theme->name.'.widgets.DeleteOperations.deleteTrRecord', array('data' => $this->data));
    }
    
    protected function deleteMassRecord() {
        $this->render('webroot.themes.'.Yii::app()->theme->name.'.widgets.DeleteOperations.deleteMassRecord', array('data' => $this->data));
    }
}