...
/**
 * EditFieldSettings. Модель для работы с таблицей "editFieldSettings"
 * 
 * @package Front
 * @category EditField
 ...
 */
class EditFieldSettings extends CActiveRecord {
    ...
    public function rules() {
        return array(
            ...
            array('key, name, fieldType', 'length', 'max' => 255),
     ...
     * @return EditFieldSettings статическая модель класса
     */
