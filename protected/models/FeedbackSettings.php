...
/**
 * This is the model class for table "feedbackSettings".
 *
 * The followings are the available columns in table 'feedbackSettings':
 * @property integer $id
 * @property string $key
...
class FeedbackSettings extends CActiveRecord {
    ...
    public static function getAdminEmail() {
        $model = FeedbackSettings::model()->findByPk(8);
        if ($model) {
            return $model->value;
        }
        return false;
